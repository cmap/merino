...
if __name__ == "__main__":
    ...
    perts = prism_metadata.read_perturbagen_from_CM_file(
        "functional_tests/test_functional_prism_metadata_perturbagen/7159-03-A02-01-01_02-29-16_12.20.32.txt", "prism_pipeline.cfg")
